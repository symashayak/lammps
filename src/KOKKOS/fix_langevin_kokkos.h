...
namespace LAMMPS_NS {
  ...
  private:
    ...
    double *rmass;
    DAT::tdual_double_2d k_franprev;
    DAT::t_double_2d d_franprev;
    HAT::t_double_2d h_franprev;

    DAT::tdual_double_2d k_flangevin;
    DAT::t_double_2d d_flangevin;
    HAT::t_double_2d h_flangevin;

    DAT::tdual_double_1d k_tforce;
    DAT::t_double_1d d_tforce;
    ...
    DAT::tdual_double_1d k_gfactor1, k_gfactor2, k_ratio;
    DAT::t_double_1d d_gfactor1, d_gfactor2, d_ratio;
    HAT::t_double_1d h_gfactor1, h_gfactor2, h_ratio;

    typedef Kokkos::DualView<double[3], LMPDeviceType::array_layout, LMPDeviceType>
      tdual_double_1d_3n;
    tdual_double_1d_3n k_fsumall;
    tdual_double_1d_3n::t_dev d_fsumall;
    tdual_double_1d_3n::t_host h_fsumall;
  ...
  template<class DeviceType>
    ...
    FixLangevinKokkosTallyEnergyFunctor(FixLangevinKokkos<DeviceType>* c_ptr):
      ...
      void operator()(const int i, value_type &energy) const {
        energy += c.template compute_energy_item(i);
      }
      KOKKOS_INLINE_FUNCTION
      static void init(volatile value_type &update) {
        update = 0.0;
