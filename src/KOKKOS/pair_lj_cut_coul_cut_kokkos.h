...
class PairLJCutCoulCutKokkos : public PairLJCutCoulCut {
 ...
 protected:
  ...
  template<bool STACKPARAMS, class Specialisation>
  KOKKOS_INLINE_FUNCTION
    F_FLOAT compute_fcoul(const F_FLOAT& rsq, const int& i, const int&j, const int& itype, const int& jtype) const;
  ...
  friend class PairComputeFunctor<PairLJCutCoulCutKokkos,N2,true>;
  friend class PairComputeFunctor<PairLJCutCoulCutKokkos,FULLCLUSTER,true >;
  ...
  friend class PairComputeFunctor<PairLJCutCoulCutKokkos,N2,false>;
  friend class PairComputeFunctor<PairLJCutCoulCutKokkos,FULLCLUSTER,false >;
